...
**Important:** the sequences are on the amino acid level and so should yours!
...
- **Convert_or_not:** write true or false in case the partition file needs to be converted. See [partition file](https://gitlab.leibniz-lib.de/jwiggeshoff/ml-supermatrix-tree/-/tree/main/#partition-file-txt-file) for more details.
